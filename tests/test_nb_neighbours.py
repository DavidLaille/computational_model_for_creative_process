...
for cue in df['cues']:
    ...
    for nb_neighbours in nbs_neighbours:
        ...
        # print(paths)
        paths_filename = f'dataframes/test_nb_neighbours_{cue}_paths_{discounting_rate}.csv'
        paths.to_csv(paths_filename, index=False, sep=',')

        # print(all_neighbours_data)
        all_neighbours_data_filename = f'dataframes/test_nb_neighbours_{cue}_all_neighbours_data_{discounting_rate}.csv'
