...
for cue in df['cues']:
    ...
    file_name = f"images/test_memory_size_{cue}_chosen_words.png"
    print(file_name)
    ...
    axs[0, 0].plot(memory_sizes, nb_steps)
    axs[0, 0].set_title('Nb_steps X memory_sizes')
    axs[0, 0].set(xlabel='memory_size', ylabel='nb_steps')
    axs[0, 1].plot(memory_sizes, similarity_chosen_word, 'tab:orange')
    axs[0, 1].set_title('similarity_chosen_word X memory_sizes')
    axs[0, 1].set(xlabel='memory_size', ylabel='similarity_chosen_word')
    axs[1, 0].plot(memory_sizes, likeability_chosen_word, 'tab:green')
    axs[1, 0].set_title('likeability_chosen_word X memory_sizes')
    axs[1, 0].set(xlabel='memory_size', ylabel='likeability_chosen_word')
    axs[1, 1].plot(memory_sizes, final_goal_value, 'tab:red')
    axs[1, 1].set_title('final_goal_value X memory_sizes')
    axs[1, 1].set(xlabel='memory_size', ylabel='final_goal_value')

    file_name = f"images/test_memory_size_{cue}.png"
    print(file_name)
