...
"""
ComputationalModel  : choisit le mot le plus agréable (best_word, likeability max) parmi ses voisins actuels    
                      autrement dit, ce modèle a une vue "locale", et son choix de meilleur mot est restreint
                      à ses N voisins, c-à-d que son choix final s'effectuera parmi les N derniers mots découverts
ComputationalModel2 : choisit le mot le plus agréable (best_word, likeability max) parmi l'ensemble des mots visités,
                      autrement dit, ce modèle a une vue "globale"
"""
